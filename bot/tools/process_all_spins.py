...
Example:
    python bot/tools/process_all_spins.py my_username
    python bot/tools/process_all_spins.py my_username --dry-run
    python bot/tools/process_all_spins.py my_username --debug
"""
